...
export function Navbar() {
    ...
    return (
        <header className="sticky top-0 z-[100] w-full bg-[#FCFCFC]/95 backdrop-blur-md">
            <div className="mx-auto flex h-24 w-full max-w-7xl items-center justify-between px-8">
                <Link href="/" className="flex items-center gap-2">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="246" height="36" viewBox="0 0 246 36" fill="none" className="h-8 w-auto">
                        <g clipPath="url(#clip0_165_95)">
                ...
                <div className="hidden md:flex items-center justify-end flex-1">
                    <nav className="flex items-center gap-8 mr-8">
                        <Link
                            href="/"
                            className={`text-sm font-medium transition-colors ${pathname === '/' ? 'text-blue-600 border-b-2 border-blue-600 pb-1' : 'text-gray-600 hover:text-primary'}`}
                        >
                            Personal
                        </Link>
                        <Link
                            href="/business"
                            className={`text-sm font-medium transition-colors ${pathname === '/business' ? 'text-blue-600 border-b-2 border-blue-600 pb-1' : 'text-gray-600 hover:text-primary'}`}
                        >
                            Business
                        </Link>
                        <Link
                            href="/onboarding"
                            className={`text-sm font-medium transition-colors ${pathname === '/onboarding' ? 'text-blue-600 border-b-2 border-blue-600 pb-1' : 'text-gray-600 hover:text-primary'}`}
                        >
                            Courier Pickup
                        </Link>
                    </nav>
                    ...
                    {/* <NavbarAuth /> */}
                    <Button asChild variant="outline" className="rounded-full border-gray-300 hover:bg-gray-50 text-gray-700 font-semibold mr-4">
                        <Link href="/login">Log In</Link>
                    </Button>
                    <Button asChild className="rounded-full bg-[#2952E3] hover:bg-blue-700 text-white font-semibold">
                        <Link href={pathname.startsWith('/business') ? '/book-consultation' : '/get-started'}>
                            {pathname.startsWith('/business') ? 'Meet with our team' : 'Start Filing'}
                        </Link>
                    </Button>
                </div>
            ...
            {isMobileMenuOpen && (
                <div className="md:hidden absolute top-[96px] left-0 w-full bg-[#FCFCFC] border-b border-gray-100 shadow-lg z-[90]">
                    <nav className="flex flex-col p-4 gap-2">
                        <Link
                            href="/"
                            onClick={() => setIsMobileMenuOpen(false)}
                            className={`text-base font-medium transition-colors px-4 py-3 rounded-lg ${pathname === '/' ? 'bg-blue-50 text-blue-600' : 'text-gray-600 hover:text-primary hover:bg-gray-50'}`}
                        >
                            Personal
                        </Link>
                        <Link
                            href="/business"
                            onClick={() => setIsMobileMenuOpen(false)}
                            className={`text-base font-medium transition-colors px-4 py-3 rounded-lg ${pathname === '/business' ? 'bg-blue-50 text-blue-600' : 'text-gray-600 hover:text-primary hover:bg-gray-50'}`}
                        >
                            Business
                        </Link>
                        <Link
                            href="/onboarding"
                            onClick={() => setIsMobileMenuOpen(false)}
                            className={`text-base font-medium transition-colors px-4 py-3 rounded-lg ${pathname === '/onboarding' ? 'bg-blue-50 text-blue-600' : 'text-gray-600 hover:text-primary hover:bg-gray-50'}`}
                        >
                            Courier Pickup
                        </Link>
                        ...
                        <div className="flex flex-col gap-3 px-2 pb-2">
                            <Button asChild variant="outline" className="w-full justify-center py-6 rounded-full border-gray-300 hover:bg-gray-50 text-gray-700 font-semibold" onClick={() => setIsMobileMenuOpen(false)}>
                                <Link href="/login">Log In</Link>
                            </Button>
                            <Button asChild className="w-full justify-center py-6 rounded-full bg-[#2952E3] hover:bg-blue-700 text-white font-semibold" onClick={() => setIsMobileMenuOpen(false)}>
                                <Link href={pathname.startsWith('/business') ? '/book-consultation' : '/get-started'}>
                                    {pathname.startsWith('/business') ? 'Meet with our team' : 'Start Filing'}
                                </Link>
                            </Button>
